...
export default {
    LOCAL_STORAGE_KEY: {
        ACTIVE_WORKSPACE_ID: 'PulseREST-ActiveWorkspaceId',
        SIDEBAR_WIDTH: 'PulseREST-SidebarWidth',
        REQUEST_PANEL_RATIO: 'PulseREST-RequestPanelRatio',
        RESPONSE_PANEL_RATIO: 'PulseREST-ResponsePanelRatio',
        REQUEST_RESPONSE_LAYOUT: 'PulseREST-RequestResponseLayout',
        THEME: 'PulseREST-Theme',
        GITHUB_STAR_COUNT: 'PulseREST-GithubStarCount',
        DISABLE_PAGE_VIEW_ANALYTICS_TRACKING: 'PulseREST-DisablePageViewAnalyticsTracking',
        DISABLE_SSL_VERIFICATION: 'PulseREST-DisableSSLVerification',
        DISABLE_IFRAME_SANDBOX: 'PulseREST-DisableIframeSandbox',
        DISABLE_AUTO_UPDATE: 'PulseREST-DisableAutoUpdate',
        ELECTRON_SWITCH_TO_CHROMIUM_FETCH: 'PulseREST-ElectronSwitchToChromiumFetch',
        GENERATE_CODE_LANGUAGE: 'PulseREST-GenerateCodeLanguage',
        GENERATE_CODE_CLIENT: 'PulseREST-GenerateCodeClient',
        GLOBAL_USER_AGENT: 'PulseREST-GlobalUserAgent',
        REQUEST_TIMEOUT: 'PulseREST-RequestTimeout',
        INDENT_SIZE: 'PulseREST-IndentSize',
        SHOW_TABS: 'PulseREST-ShowTabs',
        HIDE_PASSWORD_FIELDS: 'PulseREST-HidePasswordFields',
        CUSTOM_RESPONSE_FORMATS: 'PulseREST-CustomResponseFormats',
    },
    HOTKEYS: {
