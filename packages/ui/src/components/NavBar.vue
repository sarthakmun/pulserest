    ...
    <div class="navbar">
        ...
        <div class="right-nav-container">
            ...
            <div class="github-star">
                <a class="gh-button-container" href="https://github.com/flawiddsouza/PulseREST" rel="noopener" target="_blank" title="Star PulseREST" aria-label="Star PulseREST on GitHub">
...
import {
    exportPulseRESTCollection,
    applyTheme,
    generateNewIdsForTree,
    toTree,
    flattenTree,
    convertCollectionsFromPulseRESTToPostman,
    convertCollectionsFromPulseRESTToInsomnia,
    exportCollection,
} from '@/helpers'
...
export default {
    ...
    methods: {
        async exportCollection(value) {
            ...
            if (value === 'PulseREST') {
                exportPulseRESTCollection(collection, this.activeWorkspace.environments)
            }

            if (value === 'Postman') {
                exportCollection(await convertCollectionsFromPulseRESTToPostman(collection), value)
            }

            if (value === 'Insomnia') {
                exportCollection(await convertCollectionsFromPulseRESTToInsomnia(collection), value)
            }
        },
