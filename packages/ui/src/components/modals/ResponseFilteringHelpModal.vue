<template>
    <div v-if="showModalComp" class="help-modal">
        <modal :title="title" v-model="showModalComp" v-if="isXml">
            ...
            <p>PulseREST uses <a href="https://www.npmjs.com/package/xpath" target="_blank">xpath</a>.</p>
        </modal>
        <modal :title="title" v-model="showModalComp" v-else>
            ...
            <p>Note that there's no standard for JSONPath. PulseREST uses <a href="https://www.npmjs.com/package/jsonpath-plus" target="_blank">jsonpath-plus</a>.</p>
        </modal>
    </div>
</template>
